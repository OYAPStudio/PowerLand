        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto grid max-w-4xl gap-8 sm:grid-cols-2">
            ...
            <div
              ...
              data-aos="fade-up"
            >
              <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-gradient-to-br from-amber-400/20 to-transparent" />
              <div className="relative">
                <div className="mb-4 flex items-center gap-3">
                  <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 shadow-md">
